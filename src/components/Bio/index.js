  ...
  render() {
    return (
      <div className="flex-wrap text-center md:text-left md:flex-no-wrap w-full mx-auto max-w-sm shadow rounded-lg py-8 px-4 md:p-4 flex  mt-8 md:mt-16 mb-4 items-center bg-grey-light">
        ...
        <div>
          <p className="my-4">Hi, I'm <strong>Jan D'Hollander.</strong><br/>Frontend Developer. Want to get in touch? Contact me on Twitter</p>
          // <a href="https://twitter.com/Jan_DHollander" target="_blank" rel="noopener" className="mr-4 text-black" aria-label="twitter">
